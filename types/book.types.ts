export type Book = {
   ...
   *
   * @example "無職転生 ～異世界行ったら本気だす～ 17 (MFブックス)"
   */
  title: string;
  /**
   ...
   *
   * @example "file:///Users/jamie/Library/Developer/CoreSimulator/Devices/7987CBDB-2D07-4277-99BB-8651AE9E3F7A/data/Containers/Shared/AppGroup/C1CE866F-4177-43A6-B089-300C4A5D1819/File Provider Storage/epubs/無職転生 ～異世界行ったら本気だす～ 17 (MFブックス)"
   */
  folderUri: string;
  /**
